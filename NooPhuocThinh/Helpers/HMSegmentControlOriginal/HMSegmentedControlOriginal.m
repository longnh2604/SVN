...
@interface HMOriginalScrollView : UIScrollView
@end
...
@interface HMSegmentedControlOriginal ()

@property (nonatomic, assign) HMSegmentedControlType type;
@property (nonatomic, strong) CALayer *selectionIndicatorStripLayer;
@property (nonatomic, strong) CALayer *selectionIndicatorBoxLayer;
@property (nonatomic, readwrite) CGFloat segmentWidth;
@property (nonatomic, strong) HMOriginalScrollView *scrollView;

@end

@implementation HMOriginalScrollView
...
@implementation HMSegmentedControlOriginal
...
- (void)commonInit {
    self.scrollView = [[HMOriginalScrollView alloc] init];
    ...
    self.selectionStyle = HMSegmentedControlOriginalSelectionStyleTextWidthStripe;
    self.selectionIndicatorLocation = HMSegmentedControlOriginalSelectionIndicatorLocationUp;
    self.type = HMSegmentedControlTypeText;
...
- (void)drawRect:(CGRect)rect {    
    ...
    if (self.selectedSegmentIndex != UISegmentedControlNoSegment && !self.selectionIndicatorStripLayer.superlayer) {
        self.selectionIndicatorStripLayer.frame = [self frameForSelectionIndicator];
        [self.scrollView.layer addSublayer:self.selectionIndicatorStripLayer];
        
        if (self.selectionStyle == HMSegmentedControlOriginalSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorLocation == HMSegmentedControlOriginalSelectionIndicatorLocationDown)
    ...
    if (self.selectionStyle == HMSegmentedControlOriginalSelectionStyleTextWidthStripe && sectionWidth <= self.segmentWidth) {
    ...
    if (index == UISegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                ...
                if (self.selectionStyle == HMSegmentedControlOriginalSelectionStyleBox && [self.selectionIndicatorBoxLayer superlayer] == nil)
                    [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
