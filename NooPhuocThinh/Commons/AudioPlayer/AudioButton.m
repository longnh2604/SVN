...
NSString *playImage = @"btn_play_player.png";
NSString *stopImage = @"btn_pause_player.png";
...
{    
    ...
    CGFloat locations[3] = { 0.5, 0.8 ,1.0 };
    ...
    CGFloat components[12] = {
        30/255.0f, 30/255.0f, 30/255.0f, 0.9,    // Start colour
        230/255.0f, 230/255.0f, 230/255.0f, 1.0,	// middle colour
        201/255.0f, 201/255.0f, 201/255.0f, 0.9
    }; // End colour
...
{
    if (!loadingView) {
        loadingView = [[UIImageView alloc] initWithFrame:CGRectMake(1, 1, self.frame.size.width-2, self.frame.size.height-2)];
...
- (void)stopSpin
{
    ...
    [self setColourR:30/255.0f G:230/255.0f B:201/255.0f A:1.0];
}
