...
#define kAQDefaultBufSize 8192	//longnh fix, old = 2048 de sua bug play tren file bi giat
...
typedef enum
{
	...
	AS_INITIALIZED = 0,
	AS_STARTING_FILE_THREAD = 1,          // bắt đầu thread
	AS_WAITING_FOR_DATA = 2,              // chuẩn bị dữ liệu
	AS_FLUSHING_EOF = 3,                  // dữ liệu sẵn sàng
	AS_WAITING_FOR_QUEUE_TO_START = 4,    // xếp hàng chơi
	AS_PLAYING = 5,                       // Now Playing
	AS_BUFFERING = 6,                     // mạng không phải là tốt, tự động đệm
	AS_PAUSED = 7,                        // bằng tay tạm dừng
	AS_STOPPING = 8,                      // sắp dừng lại, nhắc nhở tự động
	AS_STOPPED = 9,                       //  đã ngừng
} AudioStreamerState;
...
@property (nonatomic, assign) BOOL fixedLength;
